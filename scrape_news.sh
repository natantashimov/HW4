...
grep -o "https://www.ynetnews.com/article/........." 3082 \
...
for FILE in *;do grep -o -E 'Netanyahu' $FILE |wc -l ;done \
>/home/mamat/netanyahu_list.txt
for FILE in *;do grep -o -E 'Gantz' $FILE | wc -l ;done \
>/home/mamat/gantz_list.txt
cd /home/mamat/
